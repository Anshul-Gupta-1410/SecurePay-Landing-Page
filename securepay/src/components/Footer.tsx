    ...
    <footer className="relative bg-obsidian pt-16 pb-8 overflow-hidden z-10">
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12 border-b border-white/5 pb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm max-w-sm leading-relaxed">
              <b>SecurePay</b> is a unified digital payment solution that allows businesses to accept, process, and manage transactions securely. Our system connects merchants to multiple payment channels through the <b>SecurePay gateway</b>, ensuring fast settlements, encrypted data flow, and real-time reporting. Whether you're a startup or enterprise, SecurePay simplifies digital payments while maintaining high security standards.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          <p>© 2026 All rights reserved. SecurePay.</p>
        </div>
      </div>
    </footer>
  );
